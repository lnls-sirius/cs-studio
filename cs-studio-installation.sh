...
sed -i -e '130corg.csstudio.trends.databrowser3/urls=pbraw://10.0.6.57:11998/retrieval' cs-studio/configuration/plugin_customization.ini
...
sed -i -e '151corg.csstudio.alarm.beast/rdb_url=jdbc:postgresql://10.0.6.57:5432/lnls_alarms' cs-studio/configuration/plugin_customization.ini
...
sed -i -e '154corg.csstudio.alarm.beast/jms_url=failover:(tcp://10.0.6.57:61616)' cs-studio/configuration/plugin_customization.ini
...
sed -i -e '138corg.csstudio.trends.databrowser3/archives=All|1|pbraw://10.0.6.57:11998/retrieval' cs-studio/configuration/plugin_customization.ini
sed -i -e '117corg.csstudio.email/smtp_host=10.0.6.48:25' cs-studio/configuration/plugin_customization.ini
